package com.ritvi.cms.webservice;
...
//    public static final String BASE_URL = "http://rajesh1may.000webhostapp.com/ritvigroup/api_old/V1/";
    public static final String BASE_URL = "http://ritvigroup.com/ritvigroup.com/ritvigroup/api_old/V1/";
    ...
    public static final String REGISTER_URL = BASE_URL + "citizen-register.php";
    public static final String LOGIN_URL= BASE_URL + "citizen-login.php";
