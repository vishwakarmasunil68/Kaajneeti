...
public class OutgoingAdapter extends RecyclerView.Adapter<OutgoingAdapter.ViewHolder> {
    ...
    public OutgoingAdapter(Activity activity, Fragment fragment, List<String> items) {
        this.items = items;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.inflate_outgoing_item, parent, false);
