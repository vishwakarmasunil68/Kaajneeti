...
public class ConnectionRequestAdapter extends RecyclerView.Adapter<ConnectionRequestAdapter.ViewHolder> {
    ...
    public ConnectionRequestAdapter(Activity activity, Fragment fragment, List<String> items) {
        this.items = items;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.inflate_connection_request_item, parent, false);
