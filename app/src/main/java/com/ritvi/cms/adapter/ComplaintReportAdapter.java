...
public class ComplaintReportAdapter extends RecyclerView.Adapter<ComplaintReportAdapter.ViewHolder> {
    ...
    public ComplaintReportAdapter(Activity activity, Fragment fragment, List<String> items) {
        this.items = items;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.inflate_complaint_report_item, parent, false);
