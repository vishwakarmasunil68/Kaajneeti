...
public class VoterComplaintAdapter extends RecyclerView.Adapter<VoterComplaintAdapter.ViewHolder> implements WebServicesCallBack {
    private List<LeaderPOJO> items;
    Activity activity;
    Fragment fragment;
    int device_height = 0;

    public VoterComplaintAdapter(Activity activity, Fragment fragment, List<LeaderPOJO> items) {
        this.items = items;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.inflate_voter_complaint, parent, false);
